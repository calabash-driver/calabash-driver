...
public class CalabashCapabilities {
	...
	public static CalabashCapabilities android(String app, String sdkVersion,
			String locale, String deviceId, String deviceName) {
	...
	public static CalabashCapabilities fromJSON(JSONObject capa)
			throws JSONException {
		CalabashCapabilities calabashCapability = new CalabashCapabilities();
		calabashCapability.setDeviceName(capa
				.getString(CalabashCapabilities.DEVICE_NAME));
		calabashCapability.setName(capa.getString(CalabashCapabilities.NAME));
		calabashCapability.setMaxInstances(capa
				.getInt(CalabashCapabilities.MAX_INSTANCES));
		calabashCapability.setLocale(capa
				.getString(CalabashCapabilities.LOCALE));

		calabashCapability.setDeviceId(capa
				.getString(CalabashCapabilities.DEVICE_ID));
		calabashCapability.setSDKVersion(capa
				.getString(CalabashCapabilities.SDK_VERSION));
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((getSDKVersion() == null) ? 0 : getSDKVersion().hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getSDKVersion() == null) {
			if (other.getSDKVersion() != null)
				return false;
		} else if (!getSDKVersion().equals(other.getSDKVersion()))
			return false;
		return true;
	}
	...
	public String toString() {
		return "CalabashCapabilities [raw=" + raw + ", getLocale()="
				+ getLocale() + ", getSDKVersion()=" + getSDKVersion()
				+ ", getDeviceName()=" + getDeviceName() + ", getDeviceId()="
				+ getDeviceId() + "]";
	}

	public static CalabashCapabilities nexus() {
		return android("eBay:1.7.0", "4.0.4", "de_DE", "0149948604012003",
				"GalaxyNexus");
	}
