...
public enum CalabashCommands {
  ...
  SEARCH_FOR("search_for", "", WebDriverLikeCommand.VIEW),
  TAKE_SCREENSHOT("take_screenshot_embed", "", WebDriverLikeCommand.VIEW),
  SELECT_ITEM_FROM_NAMED_SPINNER("select_item_from_named_spinner", "", WebDriverLikeCommand.SPINNER),
  SELECT_ITEM_BY_NAME("select_item_by_name", "", WebDriverLikeCommand.SPINNER),
