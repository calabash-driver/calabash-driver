...
public class CalabashCommandHandler extends BaseCommandHandler {
  ...
  public WebDriverLikeResponse handle() throws Exception {
    ...
    //important for the selenium grid
    int webdriverResponseStatusCode;
    if (response.getBoolean("success")) {
      webdriverResponseStatusCode = 0;
    } else {
      webdriverResponseStatusCode = 13;
    }

    return new WebDriverLikeResponse(sessionId, webdriverResponseStatusCode, response);
  }
