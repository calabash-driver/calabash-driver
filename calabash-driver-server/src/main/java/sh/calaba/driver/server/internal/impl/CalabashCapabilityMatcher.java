...
/**
 * Default calabash-driver server capability matcher.
 */
public class CalabashCapabilityMatcher implements CapabilityMatcher {
  private final List<String> toConsider = new ArrayList<String>();

  public CalabashCapabilityMatcher() {
    toConsider.add(CalabashCapabilities.LOCALE);
    toConsider.add(CalabashCapabilities.AUT);
    toConsider.add(CalabashCapabilities.SDK_VERSION);
  }
