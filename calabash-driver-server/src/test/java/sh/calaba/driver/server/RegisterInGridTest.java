...
public class RegisterInGridTest {
  ...
  public List<CalabashCapabilities> getCalabashCapabilities() throws JSONException {
    ...
    capabilities.add(CalabashCapabilities.android("app:1", "2.3", "en_GB", "304D19CE983D818E",
        "GT-N7000", "sh.calabash.demoproject", "sh.calabash.demoproject.HelloAndroidActivity"));
    capabilities.add(CalabashCapabilities.android("app:2", "4.0.3", "de_DE", "0149948604012003",
        "GalaxyNexus", "sh.calabash.demoproject", "sh.calabash.demoproject.HelloAndroidActivity"));
